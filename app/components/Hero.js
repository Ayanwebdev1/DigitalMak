    ...
    <>
      <div className="flex justify-between px-7">
        ...
        <div className="text-black text-[30px] max-w-[500px] mt-23">
          <div className="text-[20px] font-bold mb-2 ml-11">Welcome to DigitalMak.com</div>
          <div className="font-bold text-[31px] ml-11">
            Full Stack Web Development <span className="text-[#B82B32]">Company</span>
          </div>
          <div className="text-[15px] mt-3.5 ml-11 ">We build high-quality websites that deliver results. From design to deployment, our team creates scalable, user-friendly, and visually engaging digital solutions. Every project is crafted to enhance your brand, improve user experience, and drive measurable growth efficiently.</div>
        </div>

        <div className="relative w-80 h-80 mr-24 mt-15">
          <div className="  absolute inset-0shadow-lg ">
            <img
              src="/laptop.png"
              alt="Ayan Khalid"
              className="w-[350px] h-[300px] mt-10"
            />
          </div>
        </div>
      </div>
      <div className="buttons flex ml-7 gap-3">
        <Link href="/getquote"><button className=" btn ml-11  p-[15px]  bg-[#B82B32] text-white rounded-lg cursor-pointer">Get a Quote</button></Link>

        <button onClick={()=>window.open("https://calendly.com/ayankhalid4447/15-minutes-meeting","_blank")} className=" btn ml-11  p-[15px] bg-[#ffffff] text-black border rounded-lg cursor-pointer" >Book a Call</button>
        <button></button>
      </div>

      <hr className="mt-42 text-[#B82B32] mb-10" />

      <h1 className="text-center text-[30px] font-bold">Web <span className="text-[#B82B32]">Development & Designing</span> Agency</h1>

      <div className="text-center mt-5 w-[60%] m-auto mb-5">
      ...
      <div className=" text-center mt-5 w-[60%] m-auto mb-7">
      ...
      <div className="boxes flex flex-wrap justify-center gap-4 ">
        ...
        <div className="w-full box-border min-h-[600px] border-none m-2 bg-[#bfbfbf4a]
        flex justify-around">

          <div className="lefttext w-[50%]">
            <h1 className="font-bold text-[35px] mt-[70px] ml-15" >Best Web <span className="text-[#B82B32]" >Desigining</span> and <br /> <span className="text-[#B82B32] font-bold text-[35px] mt-[70px] ">Development</span></h1>

            <div className="ml-15 mt-6 w-[90%]">We’re not just another web agency — we build powerful, scalable digital experiences that drive real results.
          ...
          <div className="rightboxes w-[50%] mt-2 ml-[200px]">

            <div className="box w-[500px] h-[180px] border border-[#B82B32] rounded-lg bg-black mb-2">
              <h1 className="text-white text-[20px] text-center mt-1 ">Our Mission</h1>
              <div className="text-white m-auto p-1 text-center">Our mission is to empower brands through innovation, design, and technology.
                We aim to deliver digital experiences that not only look great but also perform flawlessly. Every project we take is driven by strategy, creativity, and measurable results.</div>
            </div>
            ...
            <div className="box w-[500px] h-[180px] border border-[#B82B32] rounded-lg bg-black">
      ...
      <div className="whychoose">
        ...
        <div className='m-auto mt-5 text-center w-[70%]'>At DigitalMak, we don’t just build websites — we build growth engines for your brand.
